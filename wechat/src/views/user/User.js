      ...
      <div id='user'>
        ...
        <div className='userInfo-content'>
          ...
          <div className='items-wrap'>
            <div className='user-item'>
              <div className='icon-wrap'>
                <span className='iconfont icon-qianbao'/>
              </div>
          ...
          <div className='items-wrap'>
            ...
            <div className='user-item'>
              <div className='icon-wrap'>
                <span style={{ fontSize: '.2rem' }} className='iconfont icon-photo'/>
              </div>
            ...
            <div className='user-item'>
              <div className='icon-wrap'>
                <span style={{ fontSize: '.2rem' }} className='iconfont icon-kabao'/>
              </div>
            ...
            <div className='user-item'>
              <div className='icon-wrap'>
                <span style={{ fontSize: '.2rem' }} className='iconfont icon-face2'/>
              </div>
          ...
          <div className='items-wrap'>
            <div className='user-item'>
              <div className='icon-wrap'>
                <span  style={{ fontSize: '.2rem' }} className='iconfont icon-setting'/>
              </div>
